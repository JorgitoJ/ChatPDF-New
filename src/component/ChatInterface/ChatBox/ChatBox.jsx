...
export const ChatBox = () => {
  ...
  return (
    ...
    <div className='flex-1 overflow-y-auto overflow-x-hidden p-4'>
      <div className="min-h-full flex flex-col justify-center min-w-0">
        {messages.length === 0 ? (
          ...
          <div className="space-y-2">
            ...
            {isLoading && (
              <div className="flex justify-start mb-4">
                <div className="bg-gray-200 text-gray-800 rounded-lg rounded-bl-none px-4 py-2 max-w-[70%] wrap-break-word whitespace-pre-wrap min-w-0">
